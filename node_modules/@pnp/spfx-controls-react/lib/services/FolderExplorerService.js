...
var FolderExplorerService = (function () {
    function FolderExplorerService(serviceScope) {
         ...
         */
        this.GetRootFolder = function (listId) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._getRootFolder(listId)];
            });
        }); };
        /**
         * Get root folder from library
         * @param listId - the ID of the library to query
         */
        this._getRootFolder = function (listId) { return __awaiter(_this, void 0, void 0, function () {
            var rootFolder, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        rootFolder = null;
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, sp_1.sp.web.lists.getById(listId).rootFolder.select('Name', 'ServerRelativeUrl').usingCaching().get()];
                    case 2:
                        rootFolder = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        ...
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/, rootFolder];
                }
            });
        }); };
        /**
