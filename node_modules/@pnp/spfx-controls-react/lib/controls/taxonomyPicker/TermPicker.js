...
var TermPicker = (function (_super) {
    ...
    TermPicker.prototype.onFilterChanged = function (filterText, tagList) {
        return __awaiter(this, void 0, void 0, function () {
            var termsService, terms, termSet, filteredTerms, _a, disabledTermIds_1, disableChildrenOfDisabledParents, _loop_1, this_1, _i, terms_1, term;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(filterText !== "")) return [3 /*break*/, 8];
                        termsService = new SPTermStorePickerService_1.default(this.props.termPickerHostProps, this.props.context);
                        return [4 /*yield*/, termsService.searchTermsByName(filterText)];
                    case 1:
                        terms = _b.sent();
                        if (!this.props.isTermSetSelectable) return [3 /*break*/, 3];
                        return [4 /*yield*/, termsService.getTermSet()];
                    case 2:
                        termSet = _b.sent();
                    ...
                    case 3:
                        filteredTerms = [];
                        _a = this.props, disabledTermIds_1 = _a.disabledTermIds, disableChildrenOfDisabledParents = _a.disableChildrenOfDisabledParents;
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, termsService.getAllTerms(this_1.props.termPickerHostProps.termsetNameOrID)];
                                    case 2:
