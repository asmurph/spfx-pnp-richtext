...
var ListItemPicker = (function (_super) {
    ...
    function ListItemPicker(props) {
        ...
        _this.loadListItems = function (filterText) { return __awaiter(_this, void 0, void 0, function () {
            var _a, listId, columnInternalName, keyColumnInternalName, webUrl, filter, arrayItems, keyColumn, listItems, _i, listItems_1, item, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, listId = _a.listId, columnInternalName = _a.columnInternalName, keyColumnInternalName = _a.keyColumnInternalName, webUrl = _a.webUrl, filter = _a.filter;
                        arrayItems = [];
                        keyColumn = keyColumnInternalName || 'Id';
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._spservice.getListItems(filterText, listId, columnInternalName, keyColumn, webUrl, filter)];
                    case 2:
                        listItems = _b.sent();
