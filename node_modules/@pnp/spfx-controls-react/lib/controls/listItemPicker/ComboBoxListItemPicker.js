...
var ComboBoxListItemPicker = (function (_super) {
    ...
    function ComboBoxListItemPicker(props) {
        ...
        _this.onChanged = function (option, index, value, submitPendingValueEvent) {
            ...
            _this.props.onSelectedItem(_this.selectedItems.map(function (item) {
                return (_a = {},
    ...
    ComboBoxListItemPicker.prototype.loadOptions = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var query, keyColumnName, listItems, options;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = "";
                        query += this.props.filter || "Id gt 0";
                        keyColumnName = this.props.keyColumnInternalName || "Id";
                        return [4 /*yield*/, this._listItemRepo.getListItemsByFilterClause(query, this.props.listId, this.props.columnInternalName, this.props.keyColumnInternalName, this.props.webUrl, 
                    ...
                    case 1:
                        ...
                        options = listItems.map(function (option) {
                            return {
                                ...
                                text: option[_this.props.columnInternalName || "Id"]
                            };
                        });
                        if (this.props.defaultSelectedItems) {
                            //if passed only ids
                            if (!isNaN(this.props.defaultSelectedItems[0])) {
                                this.selectedItems = options.filter(function (opt) { return _this.props.defaultSelectedItems.indexOf(opt.key) >= 0; });
                            }
                            else {
                                this.selectedItems = options.filter(function (opt) { return _this.props.defaultSelectedItems.map(function (selected) { return selected[keyColumnName]; }).indexOf(opt.key) >= 0; });
                            }
                        }
                        this.setState({
